...
class GameViewModel @AssistedInject constructor(
    ...
    var boardState: SnapshotStateList<PanelState> =
        questionWithTags.question.boardState.toMutableStateList()
    var komadaiState: SnapshotStateList<PieceKind> =
        questionWithTags.question.myKomadai.toMutableStateList()
    var enemyKomadaiState: SnapshotStateList<PieceKind> =
        questionWithTags.question.enemyKomadai.toMutableStateList()
    ...
    fun saveQuestion(question: Question) {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            // cannot use question.id because id is autogenerated.
            val latestQuestionId = repository.getLatestQuestionId()
            questionWithTags.tags.forEach {
                repository.add(QuestionTagCrossRef(latestQuestionId, it.id))
            }
        }
    }
